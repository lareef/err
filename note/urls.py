...
from note.views import init, notes, noteitems, add_note, update_note, delete_note, add_noteitem, update_noteitem, delete_noteitem, edit_noteitem, invlist, icost
...
urlpatterns = [
    ...
    path('icost/<int:pk>/', icost, name='icost'),
]