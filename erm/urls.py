...
urlpatterns = [
     ...
     path('note_list/noteitemslist/<int:pk>', noteitemslist, name='noteitemslist'),
     path('note_list/noteitemslist_delete/<int:pk>', noteitemslist_delete, name='noteitemslist-delete'),
